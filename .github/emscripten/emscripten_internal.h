...
// Catch the current (background) thread up with all modules loaded so far,
// replaying pending dlopen/dlsym events into this thread's function table.
// Not valid on the main runtime thread.
bool _emscripten_dlsync_self(void);
